...
const Header = () => {
  return (
    <header className="h-16 border-b border-gray-800 flex items-center px-6 justify-between bg-[#111]">
      <div className="flex items-center gap-10">
        
        <div className='flex items-center space-x-2 cursor-pointer'>
        <Icon />
        <div className="font-bold text-xl">Backpack</div>
        </div>

        
        <nav className="flex items-center gap-8">
          <Link href={""} className="hover:text-white font-semibold text-white text-label">Markets</Link>
          <Link href={""} className="hover:text-white font-semibold text-white text-label">Spot</Link>
        </nav>
      </div>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3">
            <button className="bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-md font-semibold cursor-pointer">
             ...
             <button className="bg-[#222] hover:bg-gray-700 text-white px-5 py-2 rounded-md font-semibold cursor-pointer">
                Withdraw
            </button>
        </div>
